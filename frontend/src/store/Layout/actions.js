...
const getMenuSuccessAction = (menu) => {
  return {
...
const getMenuErrorAction = (error) => {
  return {
    type: GET_MENU_ERROR,
    payload: error,
  };
...
const clickOnMobileMenuAction = (strCurrentClasses) => {
...
const menuChangeHasSubItemStatusAction = (payload) => {
  return {
...
const setContainerClassnamesAction = (
  clickIndex,
  strCurrentClasses,
  selectedMenuHasSubItems
) => {
  console.log(clickIndex, strCurrentClasses, selectedMenuHasSubItems);
  const currentClasses = strCurrentClasses
...
const addContainerClassnameAction = (classname, strCurrentClasses) => {
  const newClasses =
